...
/*   Updated: 2023/12/19 19:37:00 by maldavid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace mlxut
{
	...
	void MLXinfos::onUpdate(ivec2 size)
	{
		...
		if(!ImGui::Begin("MLX Infos", nullptr, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse))
			return;
